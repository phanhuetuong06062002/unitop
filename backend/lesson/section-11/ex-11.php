...
if (isset($_POST['btn_login'])) {
    ...
    if (!empty($_POST['number_phone'])) {
        if (is_phone_number($_POST['number_phone'])) {
            $number_phone = $_POST['number_phone'];
        } else {
            $error['number_phone'] = "SĐT không đúng định dạng";
        }
    } else {
        $error['number_phone'] = " SĐT không được bỏ trống";
    }
    if (empty($error))
        echo $username . "-" . $password . "-" . $email . "-" . $number_phone;
    // }else{
    //     echo "<pre>";
    //     print_r($error);
    //     echo "</pre>";
        ...
        <div id="form-login">
            <form action="" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input class="form-input" placeholder="email" type="email" name="email" id="">
                </div>
                <?php echo form_error('email') ?>
                <div class="form-group">
                    <i class="fas fa-phone"></i>
                    <input class="form-input" placeholder="SĐT" type="text" name="number_phone" id="">
                </div>
